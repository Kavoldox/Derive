<aside class="d-none d-lg-block col-lg-4">
    ...
    <div class="card categories my-3">
        ...
        <ul class="list-group list-group-flush">
            <?php foreach ($categoriesList as $currentCategory) :?>
                <li class="list-group-item"><a href="category.php?id=<?= $currentCategory['id'] ?>"><?= $currentCategory['name'] ?></a></li>
            <?php endforeach; ?>
        </ul>
    </div>
    ...
    <div class="card authors my-3">
        ...
        <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item"><a href="author.php?id=<?= $currentAuthor['id'] ?>"><?= $currentAuthor['name'] ?></a></li>
            <?php endforeach; ?>
        </ul>
    </div>
</aside>
